...
function MyVolunteerProfile(props) {
                ...
                <View style={{paddingHorizontal: 15}}>
                      ...
                      <View style={{backgroundColor: '#f2f2f2', width: '85%'}}>
                        <RNPickerSelect
                          ...
                          <Text
                            ...
                            {formikProps.values.eventType?.label ?? 'Category'}
                          </Text>
                        </RNPickerSelect>
                      </View>
                        ...
                        <View
                          ...
                          <RNPickerSelect
                            ...
                            <Text
                              ...
                              {formikProps.values.eventType?.label ?? 'Country'}
                            </Text>
                          </RNPickerSelect>
                        </View>
                        ...
                        <View
                          ...
                          <RNPickerSelect
                            ...
                            <Text
                              ...
                              {formikProps.values.privacy?.label ?? 'City'}
                            </Text>
                          </RNPickerSelect>
                        </View>
                  ...
                  <View style={{marginTop: 15, position: 'relative'}}>
                    ...
                    <TextInput
                      ...
                      placeholder="Reason of Volunteering"
                    />
                    <Text
                      style={{
                        color: AppColor.greenButton,
...
export default MyVolunteerProfile;
